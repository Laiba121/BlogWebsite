  ...
  return (
    <footer className="bg-slate-900 px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-5 flex-wrap gap-4">
        <div>
          <span className="block text-[16px] font-bold text-white mb-1">PharmaContext</span>
          <p className="text-[12px] text-slate-500">© 2024 PharmaContext Medical Information. All rights reserved.</p>
        </div>
      ...
      <div className="border-t border-slate-800 pt-5">
        <p className="text-[11.5px] text-slate-600 text-center leading-relaxed">
          Disclaimer: The information provided on PharmaContext is for educational and informational purposes only and is not
